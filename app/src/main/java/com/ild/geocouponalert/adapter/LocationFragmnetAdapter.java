...
public class LocationFragmnetAdapter extends BaseAdapter {
    public List<BusinessLocationMaster> locationList;
    public Activity activity;
    public static LayoutInflater inflater=null;
    //public ImageLoader imageLoader; 
    public LocationFragmnetAdapter(Activity a,List<BusinessLocationMaster> location) {
        activity = a;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.parentRelativeLayout.setOnClickListener(new View.OnClickListener() {
   			...
   			public void onClick(View v) {
   				...
   				Intent intent = new Intent(activity, MapBusinessLocation.class);
				...
				activity.overridePendingTransition(R.anim.push_left_in,R.anim.push_left_out);	
   				...
   				//Toast.makeText(activity,locationObj.buss_loc_lat + "-"+ locationObj.buss_loc_long, 1000).show();
   				/*if(locationObj.distance.equalsIgnoreCase("0")){
			        ...
			        alertDialog.setMessage("Since the Distance is not available, So you are not allow to see the route map");
					...
					Intent intent = new Intent(android.content.Intent.ACTION_VIEW, 
					    Uri.parse("http://maps.google.com/maps?daddr="+locationObj.buss_loc_lat+","+locationObj.buss_loc_long));
					activity.startActivity(intent);
				}*/
